...
//The configuration items
 ...
 public void printText() {
   if (login()) {// 登陆
     ...
     System.err.println("开始跳转页面---> http://divide.jd.com/user_routing?skuId=2876449&sn=f195d9e951efc5b7a4f5d5f26818b86e&from=pc");
     redirectPage();// 跳转页面
     System.err.println("排队 -->http://bolt.jd.com/captcha.html?from=pc&skuId=2876449&sn=f195d9e951efc5b7a4f5d5f26818b86e");
     queue();// 排队
     System.err.println("验证 -->http://bolt.jd.com/validate/repeatGoToOrder");
